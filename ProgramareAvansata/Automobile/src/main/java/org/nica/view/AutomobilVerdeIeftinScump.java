...
public class AutomobilVerdeIeftinScump extends JFrame {


    public AutomobilVerdeIeftinScump ()
    {
        super("Lista celor mei scumpe si celor mai ieftine automobile de culoare verde");
    ...
    public void updateAutomobile() {
        ...
        final Object[][] rowData = Sarcini.getIeftinScumpVerde().stream()
                .map(
                        automobil ->
                                new Object []
                                        {
